class ResumeExtractor {
    ...
    async extractData() {
        ...
        try {
            ...
            const response = await fetch('https://python-rms.onrender.com/extract-resume', {
                method: 'POST',
                body: formData
            });
            ...
            while (true) {
                ...
                const pollResp = await fetch(`https://python-rms.onrender.com/extract-resume-/${jobId}`);
    ...
    async downloadData() {
        ...
        try {
            const response = await fetch('https://python-rms.onrender.com/download-data', {
                method: 'POST',
                headers: {
